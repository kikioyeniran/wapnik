...
<section class="hero relative flex min-h-[100dvh] items-end overflow-hidden bg-emerald-deep pb-[8vh] text-cream">
  {{-- INTENDED PHOTO: wide Kigali skyline / convention-centre at dusk,
       ...
       Swap public/images/hero/kigali-dusk.jpg for a real 2000px+ photo. --}}
  <img src="{{ asset('images/hero/kigali-dusk.jpg') }}"
  ...
  <div class="relative mx-auto w-full max-w-[1240px] px-6 md:px-10">
    <h1 class="hero-word mb-8 font-display text-[clamp(3.4rem,12vw,10rem)] font-light leading-[0.9] tracking-[-0.03em]">
      <span data-hero-letters>WAPNIK</span>
    </h1>

    <div class="flex flex-wrap items-end justify-between gap-10">
      <div class="max-w-[440px]">
        <span data-hero-el class="mb-4 inline-flex items-center gap-3.5 text-[0.7rem] font-medium uppercase tracking-[0.32em] text-gold-light
        ...
        <p data-hero-el class="text-lg font-light leading-snug text-cream/80">
      ...
      <div class="flex flex-col items-start gap-4">
        <a href="{{ route('apply') }}" data-hero-el
        ...
        <span data-hero-el class="text-[0.7rem] uppercase tracking-[0.2em] text-cream/50">By application &amp; invitation only</span>
      </div>
    </div>
  </div>
</section>
...
<section class="bg-paper py-[15vh]">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <p data-reveal class="mb-[8vh] text-center text-[0.7rem] font-medium uppercase tracking-[0.32em] text-gold">Our ethos</p>
...
<section class="bg-cream">
  <div class="grid items-stretch lg:grid-cols-2">
    <div data-reveal data-parallax class="order-2 overflow-hidden lg:order-1">
      {{-- INTENDED PHOTO: candid group of WAPNIK members around a long
           table in Kigali, warm evening light. --}}
      @include('partials.photo', ['src' => 'who/belonging.jpg', 'alt' => 'WAPNIK members in conversation around a table in Kigali', 'ratio' => 'aspect-[4/3] lg:aspect-auto lg:h-full', 'grade' => 'soft'])
    </div>
    <div class="order-1 flex items-center lg:order-2">
      <div class="px-6 py-[12vh] md:px-12 lg:max-w-[520px] lg:pl-16">
        <span data-reveal class="text-[0.7rem] font-medium uppercase tracking-[0.28em] text-gold">Who we are</span>
        <h2 data-reveal class="mt-5 font-display text-[clamp(2.1rem,4vw,3rem)] font-light leading-[1.05] tracking-[-0.02em]">A network, not a group chat.</h2>
        <p data-reveal class="mt-6 font-display text-xl font-light italic leading-snug text-ink">West Africans who chose Kigali.</p>
        <p data-reveal class="mt-5 max-w-[46ch] font-light text-ink-soft">Founders, doctors, diplomats, engineers, and the families beside them. We weren't short on contacts. We were short on a room where someone wants you to win.</p>
        <a href="{{ route('who-we-are') }}" data-reveal class="group mt-9 inline-flex items-center gap-4 text-[0.74rem] font-semibold uppercase tracking-[0.18em] text-emerald">
          Read who we are
...
<section class="bg-cream-2 py-[14vh]">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <div class="grid gap-14 lg:grid-cols-[1fr_1.1fr] lg:items-end">
      <div>
        <span data-reveal class="text-[0.7rem] font-medium uppercase tracking-[0.28em] text-gold">Events &amp; experiences</span>
        <h2 data-reveal class="mt-5 max-w-[14ch] font-display text-[clamp(2.1rem,4.5vw,3.4rem)] font-light leading-[1.04] tracking-[-0.02em]">Where friendships are made.</h2>
        <p data-reveal class="mt-6 max-w-[42ch] font-light text-ink-soft">From quiet coffees to the black-tie Gala, our calendar is a standing invitation. Show up as life allows.</p>
        ...
        <ul class="mt-10 divide-y divide-line border-t border-line">
          ...
          @foreach ($teaserEvents as $ev)
            <li data-reveal class="flex items-baseline justify-between gap-6 py-4">
        ...
        <a href="{{ route('events') }}" data-reveal class="group mt-9 inline-flex items-center gap-4 text-[0.74rem] font-semibold uppercase tracking-[0.18em] text-emerald">
          See the full calendar
          <span class="h-px w-9 bg-emerald transition-[width] duration-300 group-hover:w-14"></span>
        </a>
      </div>

      <div data-reveal data-parallax class="overflow-hidden">
        {{-- INTENDED PHOTO: the WAPNIK Gala — black-tie evening, candid. --}}
        @include('partials.photo', ['src' => 'events/gala.jpg', 'alt' => 'Guests at the annual black-tie WAPNIK Gala', 'ratio' => 'aspect-[4/5]'])
      </div>
    </div>
  </div>
</section>
...
<section class="relative overflow-hidden bg-gradient-to-b from-emerald-deep to-emerald py-[16vh] text-cream">
  ...
  <div class="relative mx-auto max-w-[820px] px-6 text-center md:px-10">
    <h2 data-reveal class="font-display text-[clamp(2.2rem,6vw,4rem)] font-light leading-[1.05] tracking-[-0.02em]">
      You are not signing up.<br>You are being considered.
    </h2>
    <p data-reveal class="mx-auto mt-7 max-w-[48ch] font-light text-cream/65">A few quiet questions, each read by the committee, never a bot. We say no often. That's why a yes means something.</p>
    <a href="{{ route('apply') }}" data-reveal
