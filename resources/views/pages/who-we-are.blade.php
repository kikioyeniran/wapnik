...
<header class="bg-emerald-deep pt-36 pb-24 text-cream md:pt-40">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <span data-reveal class="text-[0.7rem] font-medium uppercase tracking-[0.32em] text-gold">Who we are</span>
    <h1 data-reveal class="mt-6 max-w-[16ch] font-display text-[clamp(2.6rem,7vw,5.5rem)] font-light leading-[0.98] tracking-[-0.03em]">
      A network, not a group chat.
    </h1>
    <p data-reveal class="mt-7 max-w-[52ch] font-light text-cream/70">West Africans who chose Kigali. Founders, doctors, diplomats, engineers, and the families beside them.</p>
  </div>
</header>
...
<section class="bg-cream py-[13vh]">
  <div class="mx-auto grid max-w-[1240px] items-center gap-16 px-6 md:px-10 lg:grid-cols-[1.05fr_1fr] lg:gap-20">
    <div class="max-w-[48ch]">
      <h2 data-reveal class="font-display text-[clamp(2rem,4vw,2.8rem)] font-light leading-[1.08] tracking-[-0.02em]">We weren't short on contacts.</h2>
      <p data-reveal class="mt-6 font-display text-xl font-light italic leading-snug text-emerald">We were short on a room where someone wants you to win.</p>
      <p data-reveal class="mt-6 font-light text-ink-soft">So we built one. A circle of West African professionals putting down roots in Kigali, where the introductions are warm and the table is generous.</p>
      <p data-reveal class="mt-4 font-light text-ink-soft">And we're careful who we let in.</p>
    ...
    <div data-reveal data-parallax class="relative">
      {{-- INTENDED PHOTO: portrait of the founders / a member, Kigali. --}}
      @include('partials.photo', ['src' => 'who/founders.jpg', 'alt' => 'The founders of WAPNIK in Kigali', 'ratio' => 'aspect-[4/5]', 'class' => 'rounded-sm shadow-[0_50px_90px_-40px_rgba(12,42,31,.5)]'])
      <div class="absolute -bottom-7 -left-5 rounded-sm border-t-2 border-gold bg-emerald px-8 py-6 text-cream shadow-[0_30px_60px_-24px_rgba(0,0,0,.5)] md:-left-8">
        <div class="font-display text-4xl font-light leading-none text-gold-light" data-count="15" data-suffix="+">15+</div>
...
<section class="bg-cream-2 py-[13vh]">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <div class="max-w-[640px]">
      <span data-reveal class="text-[0.7rem] font-medium uppercase tracking-[0.28em] text-gold">Who belongs here</span>
      <h2 data-reveal class="mt-5 font-display text-[clamp(2rem,4.5vw,3.2rem)] font-light leading-[1.04] tracking-[-0.02em]">Built for professionals.</h2>
      <p data-reveal class="mt-5 font-light text-ink-soft">Find yourself on this list and you'll feel at home in the room.</p>
    </div>

    <div class="mt-14 grid gap-7 lg:grid-cols-[1.4fr_1fr] lg:items-start">
      <div data-reveal class="rounded-sm border border-line bg-paper p-10 md:p-12">
      ...
      <div data-reveal class="rounded-sm border border-gold/20 bg-emerald p-10 text-cream md:p-12">
...
<section class="bg-emerald py-[13vh] text-cream">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <div class="max-w-[640px]">
      <span data-reveal class="text-[0.7rem] font-medium uppercase tracking-[0.28em] text-gold-light">What membership means</span>
      <h2 data-reveal class="mt-5 font-display text-[clamp(2rem,4.5vw,3.2rem)] font-light leading-[1.04] tracking-[-0.02em] text-cream">Four things every member walks away with.</h2>
      <p data-reveal class="mt-5 font-light text-cream/70">Not a group to join. People in your corner.</p>
    </div>

    <div class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      @php $pillars = [
        ['n' => 'I',   'img' => 'pillars/friendships.jpg', 'alt' => 'Members sharing a meal and laughing together', 't' => 'Real friendships', 'd' => "A circle that gets where you come from, and where you're headed."],
        ['n' => 'II',  'img' => 'pillars/growth.jpg',      'alt' => 'A mentoring conversation between two professionals', 't' => 'Professional growth', 'd' => 'Warm introductions, mentorship, and opportunities off the job board.'],
        ['n' => 'III', 'img' => 'pillars/landing.jpg',     'alt' => 'A family settling into life in Kigali', 't' => 'A softer landing', 'd' => 'Trusted advice on housing, schools, and life in Kigali.'],
        ['n' => 'IV',  'img' => 'pillars/home-away.jpg',   'alt' => 'A West African cultural celebration in Kigali', 't' => 'Home, away', 'd' => 'The food, the language, the celebrations. West Africa, kept alive.'],
      ]; @endphp
      @foreach ($pillars as $p)
        <article data-reveal class="group overflow-hidden rounded-sm border border-gold/20 bg-cream/[0.03] transition-colors duration-500 hover:border-gold/50">
...
<section class="bg-cream py-[13vh]">
  <div class="mx-auto max-w-[1240px] px-6 md:px-10">
    <h2 data-reveal class="max-w-[18ch] font-display text-[clamp(2rem,4.5vw,3.2rem)] font-light leading-[1.04] tracking-[-0.02em]">Five values every member signs up to.</h2>
    <div class="mt-14 grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-5">
      ...
      @foreach ($values as $v)
        <div data-reveal class="group border-t-2 border-gold pt-6 transition-colors duration-500 hover:border-emerald">
...
<section class="bg-emerald-deep py-20 text-cream">
  <div class="mx-auto flex max-w-[1240px] flex-col items-start justify-between gap-6 px-6 md:flex-row md:items-center md:px-10">
    <p data-reveal class="font-display text-2xl font-light italic text-gold-light">Think this is your room?</p>
    <a href="{{ route('apply') }}" data-reveal class="group inline-flex items-center gap-4 rounded-sm bg-gold px-8 py-4 text-[0.78rem] font-semibold uppercase tracking-[0.18em] text-emerald-deep transition-[transform,background-color] duration-300 hover:-translate-y-0.5 hover:bg-gold-light">
